...
$(function(){jQuery.getScript("//cdn.firebase.com/v0/firebase.js").done(function(){$.each($(".post-views"),function(e,t){var a=$(t).find("#postviews"),i=$(t).attr("data-id"),o=new Firebase("https://oriaok-default-rtdb.firebaseio.com/Pages/"+i);o.once("value",function(e){var t,l=e.val(),c=!1;null==l&&((l={}).value=0,l.id=i,c=!0),a.text((t=l.value,t>=1e9?(t/1e9).toFixed(1)+"B":t>=1e6?(t/1e6).toFixed(1)+"M":t>=1e3?(t/1e3).toFixed(1)+"K":t)),l.value++,"/"!=window.location.pathname(c?o.set(l):o.child("value").set(l.value))})})})})
